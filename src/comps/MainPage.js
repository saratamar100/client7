      ...
      <main>
        ...
        <section class="grid-container">
          ...
          <div class="item">
            <img src={pic} alt="" />
            <div class="description">
              <p>נעליים אולסטאר חצי מגף, בצבע סגול</p>
            </div>
            <div class="item_cost">
              <p>150 ש"ח</p>
            </div>
